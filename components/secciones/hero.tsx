...
export function Hero() {
  return (
    <section className="relative overflow-hidden">
      ...
      <div
        aria-hidden="true"
        className="pointer-events-none absolute left-1/2 top-24 h-[420px] w-[820px] -translate-x-1/2 rounded-full bg-primary-soft blur-[120px]"
        style={{ opacity: "var(--quipu-halo)" }}
      />
